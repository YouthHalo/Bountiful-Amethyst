				...
				if (!this.getWorld().isClient) {
					...
					if (this.getWorld() instanceof net.minecraft.server.world.ServerWorld serverWorld) {
						this.getWorld().getEntitiesByClass(net.minecraft.entity.Entity.class,
								...
								entity -> entity instanceof net.minecraft.entity.LivingEntity ||
								...
								.forEach(entity -> {
									...
									} else if (entity instanceof net.minecraft.entity.decoration.EndCrystalEntity endCrystal) {
										// Trigger end crystal explosion
										endCrystal.damage(serverWorld,
												serverWorld.getDamageSources().explosion(this, this.getOwner()), 1.0F);
									}
								});
					}
					 ...
					 * net.minecraft.util.math.BlockPos checkPos = new
					 * net.minecraft.util.math.BlockPos((int)this.getX(), (int)(groundY - i),
					 * (int)this.getZ());
					 * if (this.getWorld().getBlockState(checkPos).isSolidBlock(this.getWorld(),
					 * checkPos)) {
					...
					net.minecraft.entity.AreaEffectCloudEntity areaEffectCloud = new net.minecraft.entity.AreaEffectCloudEntity(
						...
						public void tick() {
							...
							if (!this.getWorld().isClient && this.isAlive()) {
								...
								java.util.List<net.minecraft.entity.Entity> entities = this.getWorld().getOtherEntities(this,
										this.getBoundingBox());
