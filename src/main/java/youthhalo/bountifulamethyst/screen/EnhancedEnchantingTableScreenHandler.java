...
public class EnhancedEnchantingTableScreenHandler extends ScreenHandler {
    ...
    public EnhancedEnchantingTableScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, ScreenHandlerContext context) {
    ...
    public int getEnchantCost1() {
        return this.context.get((world, pos) -> 
            EnchantingUtils.getRevealCost(world, pos, 2)
        ).orElse(10);
    }
    ...
    public int getEnchantCost2() {
        return this.context.get((world, pos) -> 
            EnchantingUtils.getRevealCost(world, pos, 3)
        ).orElse(15);
    }
    ...
    public int getRevealCost() {
        return this.context.get((world, pos) -> 
            EnchantingUtils.getRevealCost(world, pos, 1)
        ).orElse(5);
    }
    ...
    public int getAmethystBlockCount() {
        return this.context.get((world, pos) -> 
            EnchantingUtils.getAmethystBlockCount(world, pos)
        ).orElse(0);
    }
}
